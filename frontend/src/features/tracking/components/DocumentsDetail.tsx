...
import type { ApiDocument, DocumentableType, LayoutContext } from '../types';
...
export const DocumentsDetail = () => {
    ...
    // ─── Fetch all transactions to resolve the ref ─────────────────────────
    ...
    // ─── Fetch documents for resolved transaction ─────────────────────────
    ...
    return (
        <div className="space-y-5 p-4">
            ...
            <div className="bg-surface rounded-xl border border-border overflow-hidden shadow-sm">
                ...
                {/* Table header */}
                <div
                    className="grid gap-4 px-6 py-3 border-b border-border text-xs font-bold text-text-secondary uppercase tracking-wider bg-surface-secondary"

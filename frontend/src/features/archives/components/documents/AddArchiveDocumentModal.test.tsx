...
describe('AddArchiveDocumentModal', () => {
    ...
    it('uploads multiple files for the selected stage and refreshes archive queries', async () => {
        ...
        expect(invalidateQueriesSpy).toHaveBeenCalledWith({ queryKey: archiveKeys.all });
        expect(invalidateQueriesSpy).toHaveBeenCalledWith({ queryKey: archiveKeys.mineAll });

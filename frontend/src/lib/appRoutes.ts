...
export const navigationItems: {
    ...
    adminBrokerage: [
        ...
        { label: 'Tracking', path: appRoutes.liveTracking, newTab: true, icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z' },
...
export const adminDashboardQuickLinks = [
    ...
    { label: 'New Import', path: appRoutes.imports, color: '#64d2ff', icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12' },
];

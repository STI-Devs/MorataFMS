...
export const ModuleSwitcher = ({ activeModule, hasBrokerage, hasLegal, onSwitch }: Props) => {
    ...
    return (
        <div className="flex w-full gap-1 p-1 rounded-lg bg-sidebar-accent/60 group-data-[collapsible=icon]:flex-col group-data-[collapsible=icon]:p-0.5 group-data-[collapsible=icon]:gap-1 group-data-[collapsible=icon]:items-center">
            {hasBrokerage && (
                <Tooltip>
                    <TooltipTrigger asChild>
                        <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 px-2 rounded-md text-xs font-semibold transition-all group-data-[collapsible=icon]:size-7 group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:flex-initial ${
                        ...
                        >
                            ...
                            <span className="group-data-[collapsible=icon]:hidden">Brokerage</span>
                        </button>
                    </TooltipTrigger>
